...
echo "<script language='JavaScript1.2'>
 	  opener.document.form1.dateap.value=\"$jour/$mois/$annee\"; 
...
function calendar($date = '') {
	...
	$param_d['link_on_day']			= 'calendrierarrivee.php?type=modif&datechoisi='; // Link to put on each day
...
$nom_page="calendrierarrivee.php";

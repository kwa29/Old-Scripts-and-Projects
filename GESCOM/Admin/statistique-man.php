		...
		if (!$fd) die("Impossible d'ouvrir le fichier $fichier:Ouverture stoppé"); // si fopen retourne faux c'est que le fichier ne peut Йtre ouvert en Иcriture 
			while (! feof($fd))
				...
				$liste9=str_replace(",",".",$liste[9]);						// CATotal
                                ...
                                // Modif BGU pour ne pas integre le mois en cours mais uniquement le mois qui nous interess (moisav)
				//if (($liste1==$lemoisav)||($liste1==$lemois))			// Nettoyage du fichier
				if ($liste1==$lemoisav)			// Nettoyage du fichier
					{			
...
// Modif BGU - retrait du Delete avant traitement qui supprime les enregistrements de 2 mois ... mettre // sur requete1

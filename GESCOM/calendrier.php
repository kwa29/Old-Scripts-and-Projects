...
echo "<script language='JavaScript1.2'>
 	  opener.document.form1.futur.value=\"$jour/$mois/$annee\"; 
...
function calendar($date ='') {
	...
	$param_d['link_on_day']			= 'calendrier.php?type=modif&datechoisi='; // Link to put on each day
...
$nom_page="calendrier.php";
//require "administration/stats/visiteur.php";  
?>
